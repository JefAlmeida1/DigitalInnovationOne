...
function start() {
    ...
    function explosao1(inimigo1X,inimigo1Y) {
        ...
        $("#explosao1").css("background-image", "url(..//arquivos/images/explosao.png)");
	...
	function explosao2(inimigo2X,inimigo2Y) {
        ...
        $("#explosao2").css("background-image", "url(..//arquivos/images/explosao.png)");
    ...
    function energia() {
        if (energiaAtual == 3) {
            $("#energia").css("background-image", "url(..//arquivos/images/energia3.png)");
        }

        if (energiaAtual == 2) {
            $("#energia").css("background-image", "url(..//arquivos/images/energia2.png)");
        }

        if (energiaAtual == 1) {
            $("#energia").css("background-image", "url(..//arquivos/images/energia1.png)");
        }

        if (energiaAtual == 0) {
            $("#energia").css("background-image", "url(..//arquivos/images/energia0.png)");
