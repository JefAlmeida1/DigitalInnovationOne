...
using ApiCatalogoJogos1.Repositorio;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;
using static ApiCatalogoJogos1.Entities.Jogo;
...
namespace ApiCatalogoJogos1.Services
{
    public class JogoService : IJogoServices
    {
        ...
        Task<List<ViewModel.JogoViewModel>> IJogoServices.Obter(int pagina, int quantidade)
        {
            throw new NotImplementedException();
        }

        public Task<ViewModel.JogoViewModel> obter(Guid id)
        {
            throw new NotImplementedException();
        }

        public Task<ViewModel.JogoViewModel> Inserir(JogoInputModel jogo)
        {
            throw new NotImplementedException();
        }
        ...
        Task IJogoServices.Obter(Guid idJogo)
        {
            throw new NotImplementedException();
        }
    }
